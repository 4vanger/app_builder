...
Ti._5.sendAnalytics = function(isUrgent){
	...
	projectName: 'Kitchen Sink for Mobile Web',
	projectId: 'com.appcelerator.kitchensink.html5',
	deployType: 'all',
	appId: 'com.appcelerator.kitchensink.html5',
	appAnalytics: 'false',
	appPublisher: 'Appcelerator',
	appUrl: 'http://www.appcelerator.com',
	appName: 'Kitchen Sink for Mobile Web',
	appVersion: '1.7.0',
	appDescription: 'Titanium for the Mobile Web',
	...
	oParentNamespace.Styleable = function(obj, args) {
		...
		*/
		...
		Object.defineProperty(obj, 'opacity', {
			get: function() {
				return obj.dom.style['-webkit-opacity'];
			},
			set: function(val) {
				obj.dom.style['-webkit-opacity'] = val;
			}
		});
	...
	obj.render = function(parent) {
		...
		if (parent) {
			...
			if (parent['layoutStyle']=='horizontal') {
				obj.dom.style['float'] = 'left';
				obj.dom.style['position'] = 'relative';
				obj.dom.style['margin-left'] = (obj.args)?obj.args['left']:obj.dom.style['left'];
				obj.dom.style['left']='';
			}
			// handle vertical layout
			else if (parent['layoutStyle']=='vertical') {
				parent.dom.style['clear'] = 'both';
				obj.dom.style['position'] = 'relative';
				obj.dom.style['margin-top'] = (obj.args)?obj.args['top']:obj.dom.style['top'];
				obj.dom.style['display'] = 'block';
				obj.dom.style['top']='';
	...
	Object.defineProperty(this, 'hasDetail', {
		...
		set: function(val){
			...
			if (_hasDetail) {
				...
				detail.dom.style['margin-top'] = -16;
...
(function(api){
	...
	api.id = "com.appcelerator.kitchensink.html5";
	api.name = "Kitchen Sink for Mobile Web";
	api.version = "1.7.0";
	api.publisher = "Appcelerator";
	api.description = "Titanium for the Mobile Web";
...
Ti._5.createClass('Titanium.UI.Label', function(args){
	...
	Object.defineProperty(this, 'textAlign', {
		get: function(){return obj.dom.style['text-align'];},
		set: function(val){return obj.dom.style['text-align'] = val;}
	});
...
(function(api){
	...
	api.open = function(name, version, desc, size) {
		return new Titanium.Database.DB({
			name: name,
			version: version,
			desc: desc,
			size: size
...
Ti._5.createClass('Titanium.Database.DB', function(args){
	...
	var db = openDatabase(args.name, args.version, args.desc, args.size);
